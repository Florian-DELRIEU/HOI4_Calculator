...
class BattleWindow(tk.Tk):
    ...
    # CADRE PARAMETRES DE BATAILLE
        ...
        self.attacker_leader_label = tk.Label(self.frame_leaders, text="Leader Attaquant : Aucun",font=("Arial", 12, "bold"), bd=2, relief=tk.RIDGE)
        ...
        self.defender_leader_label = tk.Label(self.frame_leaders, text="Leader Défenseur : Aucun",font=("Arial", 12, "bold"), bd=2, relief=tk.RIDGE)
    ...
    # TACTIQUES ET PHASES DE BATAILLE
        ...
        self.attacker_tactic_label = tk.Label(frame_tactics, text="Tactique Attaquant : Aucune",font=("Arial", 12, "bold"))
        self.attacker_tactic_label.pack(side=tk.LEFT, padx=20)
        # Label pour la tactique du camp défenseur (à droite)
        self.defender_tactic_label = tk.Label(frame_tactics, text="Tactique Défenseur : Aucune",font=("Arial", 12, "bold"))
    ...
    # RIVIERES
        tk.Checkbutton(frame_params, text="Petite Rivière", variable=self.small_river_box,command=on_river_change(self)).grid(row=0, column=4, padx=5)
        tk.Checkbutton(frame_params, text="Grande Rivière", variable=self.large_river_box,command=on_river_change(self)).grid(row=1, column=4, padx=5)
        tk.Checkbutton(frame_params, text="Encerclement", variable=self.encirclement_box,command=on_encirclement_change(self)).grid(row=0, column=5, padx=5)
