...
Tactic(attacker_bonus=1.25, weight=2, name="Assaut",
       countered_by="Counter Attack",
       begin_phase="Close Quarter Combat"),
Tactic(defender_bonus=0.75, name="Shock",
       countered_by="Ambush"),
Tactic(attacker_bonus=1.1, defender_bonus=0.95, name="Infiltration Assaut"),
Tactic(attacker_bonus=1.15, defender_bonus=1, name="Well-Planned Attack"),
Tactic(attacker_bonus=1.20, defender_bonus=1.05, name="Relentless Assault"),
...
Tactic(attacker_bonus=0.75, defender_bonus=1.15, name="Delay",
       countered_by="Shock"),
Tactic(attacker_bonus=0.75, defender_bonus=1, name="Ambush",
...
ATK_CQ_TACTICS = [
Tactic(attacker_bonus=1.1, defender_bonus=1.05, name="Close Quarter Attack"),
Tactic(attacker_bonus=1.2, defender_bonus=1.2, weight=2, name="Close Quarter Storm"),
Tactic(attacker_bonus=1.05, defender_bonus=1.05, weight=1, name="Close Quarter Withdraw",
       begin_phase="Default"),
]

## Close Quarter Defense
DEF_CQ_TACTICS = [
Tactic(attacker_bonus=1.1, defender_bonus=1.05, name="Close Quarter Defense"),
Tactic(attacker_bonus=0.8, defender_bonus=1, weight=2, name="Close Quarter Local Strongpoint"),
]
